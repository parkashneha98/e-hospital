...
public class editprofiledoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editprofiledoctor);
    ...
    public void update_profile(View v){
        ...
        EditText name_edit = findViewById(R.id.nameedit_et);
        EditText email2_edit = findViewById(R.id.emailedit_et);
        EditText areaofinterest_edit = findViewById(R.id.aoiedit_et);
        EditText education_edit = findViewById(R.id.educedit_et);
        EditText experience_edit = findViewById(R.id.experienceedit_et);
        EditText speciality_edit = findViewById(R.id.specialedit_et);
        EditText mobileno_edit = findViewById(R.id.mobileedit_et);
        EditText workinghours_edit = findViewById(R.id.hoursedit_et);
        ...
        ref2.setValue(dataModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(editprofiledoctor.this, "successfuly updated", Toast.LENGTH_SHORT).show();
                }
